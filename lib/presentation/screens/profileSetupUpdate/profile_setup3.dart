// lib/presentation/screens/profileSetupUpdate/profile_setup3.dart
import 'package:MenuSideKick/core/routes/routes.dart';
import 'package:MenuSideKick/presentation/screens/profileSetupUpdate/profile_setup_widgets/profile_setup3_bottom_sheet.dart';
...
class ProfileSetup3ScreenUpdate extends StatefulWidget {
  const ProfileSetup3ScreenUpdate({super.key});

  @override
  State<ProfileSetup3ScreenUpdate> createState() => _ProfileSetup3ScreenUpdateState();
}

class _ProfileSetup3ScreenUpdateState extends State<ProfileSetup3ScreenUpdate>
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: CustomButton(
          ...
          onTap: () => context.go(RoutePath.profileSetup4Update.addBasePath),
        ),
      ),
                ...
                AnimatedBuilder(
                  ...
                  builder: (context, _) {
                    return ProfileSetupHeading(
                      ...
                      onBack: () => context.go(RoutePath.profileSetup2Update.addBasePath),
                    );
                  },
                ),

// lib/presentation/screens/profileSetupUpdate/profile_setup1.dart
...
class _ProfileSetup1ScreenUpdateState extends State<ProfileSetup1ScreenUpdate>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Obx(() {
          // Show loading indicator while fetching eating styles
          if (profileController.isLoadingEatingStyles.value) {
            return const Center(child: CircularProgressIndicator());
          }

          // If no eating styles loaded, show empty state
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Display eating styles from API
                Wrap(
                  spacing: 16,
                  runSpacing: 16,
                  children: [
                    // API-loaded eating styles
                    ...List.generate(
                    ...
                    // See More button (if more than 5 items)

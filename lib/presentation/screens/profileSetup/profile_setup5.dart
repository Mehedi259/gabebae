          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.person_outline, color: Colors.grey, size: 22),
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: isSelected ? const Color(0xFFE27B4F) : Colors.transparent,
                          width: 1,
                        ),
                      ),
                      child: ClipOval(
              ...
              SizedBox(
                ...
                child: CustomButton(
                  text: "Let’s Eat 🌿",
                  onTap: () => context.go(RoutePath.profileSetup6.addBasePath),
                ),
              ),
            ],
          ),
